...
namespace SPALM.SPSF.Library
{
    ...
    public static class DeploymentHelpers
    {
        internal static bool CheckRebuildForSelectedProjects(DTE dte)
        {
            ...
            {
                if (!CheckRebuildForProject(dte, project))
                {
                    return false;
                }
            }
        ...
        internal static void DeploySolutions(DTE dte)
        {
            ...
            DeployProject(dte, Helpers.GetSelectedDeploymentProjects(dte));
        ...
        internal static void UndeploySolutions(DTE dte)
        {
            ...
            UndeployProject(dte, Helpers.GetSelectedDeploymentProjects(dte));
        ...
        internal static void UpgradeSolutions(DTE dte)
        {
            ...
            UpgradeProject(dte, Helpers.GetSelectedDeploymentProjects(dte));
            Helpers.HideProgress(dte);
        }
        ...
        public static string GetDeploymentPathOfItem(DTE dte, ProjectItem selectedItem)
        {
            ...
            try
            {
                ...
                try
                {
                    ISharePointProjectItemFile selectedSharePointItem = projectService.Convert<ProjectItem, ISharePointProjectItemFile>(selectedItem);
                    ...
                    if (path.Contains("{FeatureName}"))
                    {
                        ...
                        ISharePointProjectItem sharePointItem = projectService.Convert<ProjectItem, ISharePointProjectItem>(selectedItem);
                        if (sharePointItem == null)
                        {
                            if (selectedItem.Collection.Parent is ProjectItem)
                            {
                                sharePointItem = projectService.Convert<ProjectItem, ISharePointProjectItem>(selectedItem.Collection.Parent as ProjectItem);
                            }
                        }                       
