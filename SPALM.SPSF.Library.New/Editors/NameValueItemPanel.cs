namespace SPALM.SPSF.Library
{
    ...
    [ServiceDependency(typeof(DTE)), ServiceDependency(typeof(IServiceProvider)), ServiceDependency(typeof(IDictionaryService)), ServiceDependency(typeof(ITypeResolutionService)), ServiceDependency(typeof(IValueInfoService))]
