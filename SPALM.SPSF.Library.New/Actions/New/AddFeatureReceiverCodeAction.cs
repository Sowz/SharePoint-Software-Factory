                    ...
                    if (parentfeature != null)
                    {
                        if (string.IsNullOrEmpty(parentfeature.Model.ReceiverClass))
                        {
                            if (dte.SuppressUI || (MessageBox.Show("Feature '" + evaluatedParentFeatureName + "' contains no feature receiver. Add feature receiver?", "Add Feature Receiver?", MessageBoxButtons.YesNo) == DialogResult.Yes))
                            {
                                ...
                                ProjectItem projectItem = projectService.Convert<ISharePointProjectFeature, ProjectItem>(parentfeature);
                                ProjectItem featureXmlFile = projectService.Convert<ISharePointProjectMember, ProjectItem>(parentfeature.FeatureFile);
                        ...
                        else
                        {
                            ...
                            if (className.StartsWith("$SharePoint.Type"))
                            {
                                ...
                                if (parentfeature.EventReceiverFile != null)
                                {
                                    ...
                                    ProjectItem existingCode = projectService.Convert<ISharePointProjectMember, ProjectItem>(parentfeature.EventReceiverFile);
